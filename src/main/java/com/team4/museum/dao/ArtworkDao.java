...
public class ArtworkDao extends BaseDao<ArtworkVO> {
	...
	public List<ArtworkVO> getAll(Pagination pagination) {
		return getAll(null, null, null, pagination);
	}

	public List<ArtworkVO> getAll(String category, Pagination pagination) {
		return getAll(category, null, null, pagination);
	}

	public List<ArtworkVO> getAll(String category, String displayyn, Pagination pagination) {
		return getAll(category, displayyn, null, pagination);
	}
	...
	public int getCount(String category) {
		return getCount(category, null, null);
	}

	public int getCount(String category, String displayyn) {
		return getCount(category, displayyn, null);
	}
