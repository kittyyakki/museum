	...
	<form action="museum.do?command=galleryUpdateForm" method="post" name="galleryForm" class="gallery-form"
		...
		<div class="gallery-form_info">
			...
			<ul class="gallery-form-img">
				...
				<li>
					<img alt="image" src="images/gallery/${mgvo.savefilename}" name="uploadedImage">
				</li>
			</ul>
		</div>
		<div class="gallery-form_btn">
			...
			<input class="btn" type="button" value="목록으로" onclick="location.href='museum.do?command=galleryView&mseq=${mgvo.mseq}'">
		</div>
	</form>
</section>
