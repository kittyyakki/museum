	...
	<header>
		...
		<nav>
			<h1 data-aos="fade-in" data-aos-offset="200" data-aos-easing="ease-in">
				<svg id="header_logo_v" width="300" height="28.714" viewBox="0 0 200 30" xmlns="http://www.w3.org/2000/svg" onclick="location.href='museum.do?command=index'">
