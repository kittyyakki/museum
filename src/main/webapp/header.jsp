...
<body>
	<header>
		...
		<nav>
			<h1 data-aos="fade-in" data-aos-offset="200" data-aos-easing="ease-in">
				...
				<svg id="header_logo_v" width="300" height="40.714" viewBox="0 0 300 40" xmlns="http://www.w3.org/2000/svg" onclick="location.href='museum.do?command=index'">
					...
					<!-- 청색 -->
    <rect x="0" y="0" width="40" height="20" fill="#0052A5"/>
    <!-- 붉은색 위쪽 태극 -->
    <circle cx="20" cy="20" r="16" fill="#D70000"/>
    <path d="M20 4 A 16 16 0 0 1 20 36 A 16 16 0 0 1 20 4 Z" fill="#D70000"/>
    <!-- 흰색 아랫부분 -->
    <circle cx="20" cy="20" r="12" fill="#FFFFFF"/>
    <!-- 청색 위쪽 태극 -->
    <circle cx="20" cy="20" r="8" fill="#0052A5"/>
    <path d="M20 12 A 8 8 0 0 1 20 28 A 8 8 0 0 1 20 12 Z" fill="#0052A5"/>
    <!-- 세로줄 -->
    ...
    <rect x="0" y="18" width="40" height="4" fill="#fff"/>
					...
					<path class="logo04" id="logo_outline04" data-duration="100" stroke="#000" fill="#000" fill-opacity="0"
						...
						vector-effect="non-scaling-stroke" />	
					<path class="logo05" id="logo_outline05" data-duration="100" stroke="#000" fill="#000" fill-opacity="0" d="M 2.632 1.914 L 2.632 6.699 L 11.484 6.699 L 11.484 1.914 L 14.15 1.914 L 14.15 16.27 L 0 16.27 L 0 1.914 L 2.632 1.914 Z M 22.456 19.995 L 22.456 30.386 L 19.79 30.386 L 19.79 22.183 L 2.563 22.183 L 2.563 19.995 L 22.456 19.995 Z M 22.456 0 L 22.456 18.389 L 19.79 18.389 L 19.79 0 L 22.456 0 Z M 2.632 14.082 L 11.484 14.082 L 11.484 8.853 L 2.632 8.853 L 2.632 14.082 Z M 27.036 7.93 L 27.036 10.151 L 21.704 10.151 L 21.704 7.93 L 27.036 7.93 Z" vector-effect="non-scaling-stroke" />
					<path class="logo06" id="logo_outline06" data-duration="100" stroke="#000" fill="#000" fill-opacity="0" d="M 24.131 17.021 L 24.131 23.823 L 6.084 23.823 L 6.084 27.583 L 3.418 27.583 L 3.418 21.807 L 21.499 21.807 L 21.499 19.106 L 3.35 19.106 L 3.35 17.021 L 24.131 17.021 Z M 27.686 11.826 L 27.686 14.014 L 0 14.014 L 0 11.826 L 27.686 11.826 Z M 24.097 0 L 24.097 9.263 L 3.589 9.263 L 3.589 0 L 24.097 0 Z M 25.054 26.899 L 25.054 29.019 L 3.418 29.019 L 3.418 26.899 L 25.054 26.899 Z M 6.255 2.153 L 6.255 7.109 L 21.431 7.109 L 21.431 2.153 L 6.255 2.153 Z M 15.142 13.296 L 15.142 18.013 L 12.476 18.013 L 12.476 13.296 L 15.142 13.296 Z" vector-effect="non-scaling-stroke" />
