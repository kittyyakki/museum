...
<section class="admin-list">
	<form method="post" name="adminForm">
		...
		<ul class="admin-list-header admin-artwork-list">
			...
			<li>
				<select onchange="displayFilter('adminArtworkList', 'displayState')" name="selectDisplayFilter" class="admin-select">
			...
			<li>번호</li>
			<li>
				<select onchange="categoryFilter('adminArtworkList', 'artworkCategory', event)" name="selectCategoryFilter"
					class="admin-select">
		...
		<c:forEach items="${artworkList}" var="avo" varStatus="index">
			<ul class="admin-list-main admin-artwork-list" onclick="go_check(event)">
				...
				<li>${avo.indate}</li>
				<li>
					<img alt="artwork-img" src="${avo.fullSavefilename}" onmouseover="previewImg('artwork-${avo.aseq}-${index}')"
						onmouseleave="previewImg('artwork-${avo.aseq}-${index}')">
				</li>
			</ul>
