...
<div class="main-section_text">
	<ul class="main-info-area">
		<li class="main_info">
			<strong class="main_info-tit">관람시간</strong>
		...
		<li class="main_admission">
			<strong class="main_info-tit01"> 관람료</strong>
	...
	<div class="main_info info-link">
		<ul>
			<li>
				<a href="#" class="main_btn btn-over">오시는길</a>
			</li>
			<li>
				<a href="#" class="main_btn btn-over">예약하기</a>
			</li>
		</ul>
	</div>
</div>
